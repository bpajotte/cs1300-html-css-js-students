...
const apiRequest = async () => {
  ...
  // This endpoint (https://ww\w.fruityvice.com/doc/index.html#api-GET-getAll) returns a list of all the fruits and their info, feel free to play around with different endpoints!
...
const updatePage = async () => {
  ...
  const makeFruits = (fruit) => {
    ...
    existingElement.append(newFruit);
  }

  filterFruits.map(makeFruits)
